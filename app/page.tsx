...
export default function SistemaPastasPreview() {
  ...
  const enviarTudoParaBanco = async () => {
    ...
    if (registros.length === 0) {
      alert("Não existe nenhum dado para enviar.");
      return;
    }
    ...
    if (erroLimpar) {
      alert("Erro ao limpar dados antigos do banco.");
  ...
  if (!logado) {
    return (
      <div
        className="min-h-screen flex items-center justify-center p-6 bg-black bg-cover bg-center"
        style={{
          backgroundImage:
            'linear-gradient(rgba(0,0,0,0.45), rgba(0,0,0,0.7)), url("/login-bg.png")'
        }}
      >
        <div className="w-full max-w-md bg-black/55 border border-white/20 backdrop-blur-md rounded-3xl p-8 shadow-2xl text-white">
          <h1
            className="text-center italic font-black uppercase leading-none select-none mb-2"
            style={{
              fontSize: "48px",
              color: "#d1d5db",
              textShadow: `
          ...
          <h2 className="text-center text-2xl font-black mb-6">Login do Sistema</h2>
          ...
          <div className="flex flex-col gap-4">
            <input
              ...
              className="bg-white/95 text-black border border-white/20 p-4 rounded-2xl outline-none"
            />
            ...
            {erroLogin && (
              <div className="bg-red-500/20 text-red-100 border border-red-300/30 rounded-2xl p-3 font-bold text-center">
                {erroLogin}
              </div>
            )}
            ...
            <button
              onClick={fazerLogin}
              className="bg-white text-black p-4 rounded-2xl font-black hover:bg-gray-200"
            >
              Entrar
            </button>
          </div>
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        <div className="bg-white p-6 rounded-3xl shadow-xl mb-6">
          ...
          <div className="flex gap-3 flex-wrap items-center mt-6">
            ...
            <button
              onClick={sair}
              className="bg-red-100 text-red-700 px-5 py-3 rounded-2xl font-bold"
            >
              Sair
            </button>
